...
export default function MiddleAdminPage() {
  ...
  const formatSpecialFeatures = (features: string) => {
    if (!features) return ''
                      ...
                      <tbody className="bg-white divide-y divide-slate-200">
                        {orders.map((order) => (
                          <tr key={order.id} className="hover:bg-slate-50 cursor-pointer">
                            ...
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-slate-900">
                              {order.specialFeatures ? formatSpecialFeatures(order.specialFeatures) : 'Нет'}
                            </td>
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-slate-900">
              ...
              {selectedOrder && (
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3">
                      {formatSpecialFeatures(selectedOrder.specialFeatures) || 'Нет'}
                    </div>
                  </div>
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label className="text-right font-medium">
